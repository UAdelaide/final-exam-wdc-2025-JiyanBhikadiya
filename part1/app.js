...
app.get('/api/walkers/summary',async (req,res,next) => {
    try{
        const [summary] = await db.execute(`
            ...
            (SELECT COUNT(*) FROM WalkRequests JOIN WalkApplications ON WalkApplications.request_id = WalkRequests.request_id WHERE Walk.status = 'completed' AND WalkRatings.walker_id = Users.user_id) AS completed_walks
            From Users
